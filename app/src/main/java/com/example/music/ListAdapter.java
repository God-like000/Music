...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView = inflater.inflate(R.layout.musicinfo, null);//list设置layout
            //初始化music_info格式
        ...
        if (mSelect == position) {
            ...
            //选中项背景
            myholder.t_song.setTextColor(ContextCompat.getColor(context,R.color.fuchsia));
            myholder.t_singer.setTextColor(ContextCompat.getColor(context,R.color.orange));
            myholder.t_albumn.setTextColor(ContextCompat.getColor(context,R.color.orange));
            myholder.t_point.setTextColor(ContextCompat.getColor(context,R.color.orange));
            myholder.t_duration.setTextColor(ContextCompat.getColor(context,R.color.orange));
        }
        else {
            ...
            //其他项背景
            myholder.t_song.setTextColor(ContextCompat.getColor(context,R.color.indigo));
            myholder.t_singer.setTextColor(ContextCompat.getColor(context,R.color.slateblue));
            myholder.t_albumn.setTextColor(ContextCompat.getColor(context,R.color.slateblue));
            myholder.t_point.setTextColor(ContextCompat.getColor(context,R.color.slateblue));
            myholder.t_duration.setTextColor(ContextCompat.getColor(context,R.color.slateblue));
        }
        return convertView;
    }
    class Myholder {
